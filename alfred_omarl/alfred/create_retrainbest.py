...
def get_args():
    ...
    parser.add_argument('--train_time_key', type=str, help="Config key setting the training duration, e.g. max_episodes, "
                                                           "max_steps, etc.")
...
def create_retrain_best(from_file, storage_name, best_experiments_mapping, n_retrain_seeds, train_time_factor,
                        train_time_key, root_dir):
    ...
    for storage_dir in storage_dirs:
        ...
        try:
            ...
            if len(corresponding_retrain_directories) > 0:
                ...
                assert train_time_key in config_dict
                config_dict[train_time_key] = int(config_dict[train_time_key]*train_time_factor)
